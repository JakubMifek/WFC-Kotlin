...
abstract class Model(
    ...
    protected val patternCount: Int,
    ...
    open fun ban(wave: Int, pattern: Int) {
        ...
        entropies[wave] =
            log(sumsOfWeights[wave], OrthogonalModel.LOG_BASE) - sumsOfWeightLogWeights[wave] / sumsOfWeights[wave]
    }
...
//                patternIndex
        ...
        val observedPattern = observePattern(wavePatterns)
